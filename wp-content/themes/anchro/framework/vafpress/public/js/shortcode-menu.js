(function($){
	$(document).ready(function(){
		...
		$('.vp-sc-element .vp-sc-element-heading a').bind('click.vafpress_sc', function(e){
			e.preventDefault();
			...
			else
			{
				...
				$modal.find('.vp-sc-element-form').vafpress_slideUp();

				if($form.exists())
				{
					$parent.addClass('active');
					$form.vafpress_slideDown();
				}
				else
				{
					code = decodeEntities(code);
					$modal.trigger('vafpress_insert_shortcode', code);
					$modal.trigger('reveal:close');
				}
			}
		});

		$('.vp-sc-insert').bind('click.vafpress_sc_insert', function(e){
			e.preventDefault();
			var $modal  = $(this).parents('.vp-sc-dialog'),
		...
		$('.vp-sc-cancel').bind('click.vafpress_sc_cancel', function(e){
			e.preventDefault();
			$('.vp-sc-element').removeClass('active');
