;(function($) {
	...
	function vafpress_init_fields($elements)
	{
	...
	function vafpress_init_groups($elements)
	{
		$elements.each(function(){
	...
	$(document).ready(function () {
		vafpress_init_fields(jQuery('.vp-metabox .vp-field'));
		vafpress_init_groups(jQuery('.vp-metabox .vp-meta-group'));
		process_binding(bindings);
		process_items_binding(items_binding);
		process_dependency(dependencies);
		vafpress_mb_sortable();
	});
	...
	$.wpalchemy.on('wpa_copy', function(event, clone){
		...
		vafpress_init_fields(clone.find('.vp-field'));
		vafpress_init_groups(clone.find('.vp-meta-group'));
