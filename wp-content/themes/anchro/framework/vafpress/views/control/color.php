...
<input id="<?php echo esc_attr($name); ?>"  class="vp-input vp-js-colorpicker" type="text" name="<?php echo esc_attr($name) ?>" value="<?php echo esc_attr($value); ?>" data-vp-opt="<?php echo esc_attr($opt); ?>" />
