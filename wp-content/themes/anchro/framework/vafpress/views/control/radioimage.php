...
<label>
	...
	<input type="radio" <?php if($checked) echo 'checked'; ?> class="vp-input<?php if($checked) echo " checked"; ?>" name="<?php echo esc_attr($name); ?>" value="<?php echo esc_html($item->value); ?>" />
