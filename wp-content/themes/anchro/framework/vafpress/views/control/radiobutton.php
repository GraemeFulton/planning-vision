...
<label>
	...
	<input <?php if($checked) echo 'checked'; ?> class="vp-input<?php if($checked) echo " checked"; ?>" type="radio" name="<?php echo esc_attr($name); ?>" value="<?php echo esc_html($item->value); ?>" />
