...
*/
VAFPRESS_AutoLoader::add_namespaces(VAFPRESS_NAMESPACE);
VAFPRESS_AutoLoader::add_directories(VAFPRESS_CLASSES_DIR, VAFPRESS_NAMESPACE);
VAFPRESS_AutoLoader::register();

class VAFPRESS_AutoLoader
{

	/**
	 * Indicates if VAFPRESS_AutoLoader has been registered.
	 * 
	 * @var boolean
	 */
	...
	public static function load($class)
	{
		...
		{
			$file = get_template_directory().'/framework/vafpress/classes'. DIRECTORY_SEPARATOR . $class;
			...
			{				
				...
				require $file;//this var uses get_template_directory 
				return true;
			}
		}
	}
	...
	public static function register()
	{
		...
		{
			spl_autoload_register(array('VAFPRESS_AutoLoader', 'load'));
		}
