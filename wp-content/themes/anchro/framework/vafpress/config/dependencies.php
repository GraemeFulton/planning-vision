...
return array(
	...
	'scripts' => array(
		...
		'paths' => array(
			...
			'bootstrap-colorpicker' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/vendor/bootstrap-colorpicker.js',
				'deps'     => array('jquery'),
				'ver'      => false,
			),
			'tipsy' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/vendor/jquery.tipsy.js',
				'deps'     => array('jquery'),
				'ver'      => '1.0.0a'
			),
			'scrollspy' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/vendor/jquery-scrollspy.js',
				'deps'     => array('jquery'),
				'ver'      => false,
			),
			...
			'jquery-typing' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/vendor/jquery.typing-0.2.0.min.js',
				'deps'     => array('jquery'),
				'ver'      => '0.2',
			),
			'ace-editor' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/vendor/ace/ace.js',
				'deps'     => array(),
				'ver'      => '1.0.0',
			),
			'select2' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/vendor/select2.min.js',
				'deps'     => array('jquery'),
				'ver'      => '3.3.2',
				'override' => true,
			),
			'select2-sortable' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/vendor/select2.sortable.js',
				'deps'     => array('jquery', 'jquery-ui-sortable', 'select2'),
				'ver'      => '1.0.0',
				'override' => true,
			),
			'reveal' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/vendor/jquery.reveal.js',
				'deps'     => array('jquery'),
				'ver'      => '1.0.0',
			),
			'shared' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/shared.min.js',
				'deps'     => array(),
				'ver'      => '1.1',
				'localize' => array(
					'name' => 'vafpress_wp',
			...
			'vp-metabox' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/metabox.min.js',
				'deps'     => array(),
				'ver'      => '2.0',
				'localize' => array(
					'name' => 'vafpress_mb',
			...
			'vp-shortcode-qt' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/shortcode-quicktags.js',
				'deps'     => array('reveal'),
				'ver'      => '1.0.0',
			),
			'vp-shortcode' => array(
				'path'     => VAFPRESS_PUBLIC_URL . '/js/shortcode-menu.js',
				'deps'     => array('reveal', 'vp-shortcode-qt'),
				'ver'      => '2.0',
				'localize' => array(
					'name' => 'vafpress_ext_sc',
					'keys' => array(
	...
	'styles' => array(
		...
		'paths' => array(
			'bootstrap-colorpicker' => array(
				'path' => VAFPRESS_PUBLIC_URL . '/css/vendor/bootstrap-colorpicker.css',
				'deps' => array(),
			),
			'tipsy' => array(
				'path' => VAFPRESS_PUBLIC_URL . '/css/vendor/tipsy.css',
				'deps' => array(),
			),
			'jqui' => array(
				'path' => VAFPRESS_PUBLIC_URL . '/css/vendor/jqueryui/themes/' . $jqui_theme . '/jquery-ui-1.9.2.custom.min.css',
				'deps' => array(),
			),
			'font-awesome' => array(
				'path' => VAFPRESS_PUBLIC_URL . '/css/vendor/font-awesome.min.css',
				'deps' => array(),
			),
			'select2' => array(
				'path' => VAFPRESS_PUBLIC_URL . '/css/vendor/select2.css',
				'deps' => array(),
			),
			'reveal' => array(
				'path' => VAFPRESS_PUBLIC_URL . '/css/vendor/reveal.css',
				'deps' => array(),
			),
			'vp-option' => array(
			...
			'vp-metabox' => array(
				'path' => VAFPRESS_PUBLIC_URL . '/css/metabox.min.css',
				'deps' => array(),
			),
			'vp-shortcode' => array(
				'path' => VAFPRESS_PUBLIC_URL . '/css/shortcode.min.css',
				'deps' => array('reveal'),
			),
		),
	),
