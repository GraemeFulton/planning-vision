...
class VAFPRESS_Control_Field_Sorter extends VAFPRESS_Control_FieldMulti implements VAFPRESS_MultiSelectable
{
	...
	protected function _setup_data()
	{
		...
		$this->add_data('opt', VAFPRESS_Util_Text::make_opt($opt));
	...
	public function render($is_compact = false)
	{
		...
		return VAFPRESS_View::instance()->load('control/sorter', $this->get_data());
	}
