 ...
 */
abstract class VAFPRESS_Control_Field implements iFactory
{
	...
	protected function _setup_data()
	{
		...
		$this->add_data('head_info', array(
			...
			'description'             => VAFPRESS_Util_Text::parse_md($this->get_description())
		));
	}
	 ...
	 * @return VAFPRESS_Control_Field Field object
	 */
