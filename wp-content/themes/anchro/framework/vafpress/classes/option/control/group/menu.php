...
class VAFPRESS_Option_Control_Group_Menu extends VAFPRESS_Option_Control_Group
{

	/**
	 * Collection of $_menu
	 * @var VAFPRESS_Option_Control_Group
	 */	
	private $_menus;

	/**
	 * Collection of controls
	 * @var VAFPRESS_Control_Field
	 */	
	private $_controls;
	...
	public function render($extra = array())
	{
		...
		return VAFPRESS_View::instance()->load('option/menu', $this->get_data());
	}
