...
class VAFPRESS_WP_Enqueuer
{
	...
	public function __construct()
	{
		...
		$loader    = new VAFPRESS_WP_Loader();
		add_action('vafpress_loader_register_' . $this->_id, array($loader, 'register'), 10, 2);
	}
	...
	{
		do_action('vafpress_loader_register_' . $this->_id, $this->_loaders, $hook_suffix);
	}
